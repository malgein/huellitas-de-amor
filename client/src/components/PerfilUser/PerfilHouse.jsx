...
const PerfilHouse = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const response = await axios.get(`http://localhost:3001/casaDeAdopcion/${id}`); // Reemplaza con tu URL de la API
        ...
        setPerfil({
          nombreDeOng: userData.nombreDeOng || "",
          nombreDeContacto: userData.nombreDeContacto || "",
          ...
          imagenPortada: "https://st4.depositphotos.com/11498520/23294/v/450/depositphotos_232945258-stock-illustration-dog-paw-seamless-pattern-heart.jpg",
          imagenPerfil: userData.foto || "",
        });
          ...
          <div className="border border-b-4 rounded-t-lg h-[350px] w-[1000px] relative ">
            ...
            <div className="flex flex-col ml-3 max-w-sm mx-auto rounded-xl space-y-2 sm:py-4 sm:flex sm:items-center sm:space-y-0 sm:space-x-6 absolute bottom-[-110px] left-0">
              ...
              <div className="flex flex-col text-lg text-black font-semibold ">
                <h1 className="mb-0">
                  {usuarioLocal.nombreDeOng }
                  {/* + " " + usuarioLocal.apellido */}
                </h1>
