				...
				<Form>
					<div>
						<Field
							...
							color={
								!validationSchema.isValidSync("nombre") ? "danger" : "success"
							}
						/>
					...
					<div>
						<Field
							...
							validationState={validationSchema}
							color={
								!validationSchema.isValidSync("especie") ? "danger" : "success"
							}
						/>
					...
					<div>
						<Field
							...
							id='descripcion'
							name='descripcion'
							errorMessage={<ErrorMessage name='descripcion' component='div' />}
							validationState={validationSchema}
							color={
					...
					<div className={styles.select}>
						<div>
							<div class='relative w-full inline-flex shadow-sm px-3 border-medium border-default-200 data-[hover=true]:border-default-400 min-h-unit-10 rounded-medium flex-col items-start justify-center gap-0 transition-background !duration-150 group-data-[focus=true]:border-danger transition-colors motion-reduce:transition-none h-14 py-2 is-filled'>
								<label
									class='block font-medium text-danger dark:text-danger-500 text-tiny will-change-auto origin-top-left transition-all !duration-200 !ease-[cubic-bezier(0,0,0.2,1)] motion-reduce:transition-none
							w-full h-full font-normal !bg-transparent outline-none placeholder:text-foreground-500 text-small'
								...
								<Field
									...
									name='tamano'
									placeholder='Tamaño'
									errorMessage={<ErrorMessage name='tamano' component='div' />}
									validationState={validationSchema}
								>
